...
diffuser_path = OrderedDict([
    ...
    # ['SD-v1.5'     , 'pretrained/pfd/diffuser/Deliberate-v2-0.safetensors'],
...
pfd_inference = prompt_free_diffusion(
    fp16=True, tag_ctx = 'SeeCoder', tag_diffuser = 'SD-v1.5', tag_ctl = 'canny',)
