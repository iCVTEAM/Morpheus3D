...
CONFIG_PATH = "configs/morpheus3d-texture.yaml"
PREVIOUS_STAGE = "morpheus3d-refine"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the Morpheus3D texture stage.")
...
def main() -> None:
    ...
    for image_path in collect_scene_images(
        ...
        command = [
            ...
            "system.guidance.cal_vsd_in_freq=True",
            "system.guidance.cal_lora_in_freq=False",
            "system.guidance.freq_bound_ratio=0.6",
            "system.guidance.guidance_scale=2.0",
            "system.guidance.guidance_scale_lora=1.",
            "system.loss.lambda_c=0.0005",
            "system.loss.lambda_vsd=3.0",
            "system.loss.lambda_3d_sds=1.",
        ]
